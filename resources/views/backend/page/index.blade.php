...
@section('content')
	...
	<?php 
		$barChart = "";
		$color = array("COLOR_RED","COLOR_ORANGE","COLOR_GREEN","COLOR_AQUA","COLOR_BLUE","COLOR_PURPLE","COLOR_GREY","COLOR_BLACK");		
				
		for($b=0; $b<count($barData); $b++){
			$barChart .= "{ label: '" .date('d F y', strtotime($barData[$b]->visitor_date)). "', value: ".$barData[$b]->jumlah.", color: " .$color[$b]." },";		
		}
	?>
	<!-- begin #content -->
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6">
				<div class="widget widget-stats bg-red">
					...
					<div class="stats-info">
						...
						<p>{{number_format($totalPengunjung)}}</p>	
					</div>
					<div class="stats-link">
						<a href="javascript:;">View Detail <i class="fa fa-users"></i></a>
					</div>
				</div>
			</div>
			<!-- end col-3 -->
			...
			<div class="col-lg-3 col-md-6">
				<div class="widget widget-stats bg-info">
					...
					<div class="stats-info">
						...
						<p>{{number_format($pengunjungOnline)}}</p>
					</div>
					<div class="stats-link">
						<a href="javascript:;">View Detail <i class="fa fa-users"></i></a>
					</div>
			...
			<div class="col-lg-3 col-md-6">
				<div class="widget widget-stats bg-black-lighter">
					...
					<div class="stats-link">
						<a href="javascript:;"> <i class="fa fa-clock"></i></a>
					</div>
				</div>
			</div>
			<!-- end col-3 -->
			...
			<div class="col-lg-8">
				...
				<div class="panel panel-inverse" data-sortable-id="index-1">
					<div class="panel-heading">
						...
						<h4 class="panel-title">Statistika Pengunjung Per Hari ( 7 Hari )</h4>
					</div>
			...
			<div class="col-lg-4">
				...
				<div class="panel panel-inverse" data-sortable-id="index-6">
					<div class="panel-heading">
						...
						<h4 class="panel-title">Agenda Hari Ini</h4>
					</div>					
					<div class="panel-body p-t-0">
						@if (count($agendaHariIni) > 0)		
								...
								<table class="table table-valign-middle">								
									<tbody>
										@for ($i = 0; $i < count($agendaHariIni); $i++)
											<tr>
												<td>
													<h5><b class="text-primary">{{ ucfirst(strtolower(trans($agendaHariIni[$i]->instansi))) }}</b></h5>
													<b>Agenda : </b>{{ ucwords(strtolower($agendaHariIni[$i]->agenda_judul)) }}<br><br>
													<b>Tempat : </b>{{ ucwords(strtolower($agendaHariIni[$i]->agenda_tempat)) }}<br>
													<b>Waktu :</b> {{ ucwords(strtolower($agendaHariIni[$i]->agenda_waktu)) }}<br>
												</td>										
											</tr>									
										@endfor
									</tbody>
							...
							<div class="card card-inverse bg-gradient-blue text-center">
								<div class="card-block">
									<blockquote class="card-blockquote">
										<p><h4 class="f-s-14 f-w-600 text-white">Tidak Ada Agenda Hari Ini</h4></p>
									</blockquote>
								</div>
							</div>
						@endif
...
@push('scripts')		
	...
	<script src="{{asset('backend/assets/plugins/nvd3/build/nv.d3.js') }}"></script>
	<script src="{{ asset('additional/js/dashboard.js?v=1.13') }}"></script>	
	<script> 
		...
		var handleBarChart = function() {
			...
			nv.addGraph(function() {
				...
				return a.yAxis.axisLabel("Total"), a.xAxis.axisLabel("Tanggal"), d3.select("#nv-bar-chart").append("svg").datum(e).call(a), nv.utils.windowResize(a.update), a
			})
		},
		ChartNvd3 = function() {
			"use strict";
