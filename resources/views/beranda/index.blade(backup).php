...
@section('content')
  ...
  <section class="call-to-action no-padding">
    <div class="container">
      ...
      <div class="row">       
        <div class="col">
          <div class="card h-100 border-top border-0 border-4 border-warning2">
            ...
            <div class="card-body" >
              ...
              </span><a data-href="/mbkm"  class="btn btn-primary action">Selengkapnya</a>
            </div>
      ...
      <div class="row">
          <div class="col-lg-4">
            <div class="subscribe-call-to-acton">
                <h3>Can We Help?</h3>
                <h5 class="text-white">www.uhw.ac.id</h5>
            </div>
          </div><!-- Col end -->
