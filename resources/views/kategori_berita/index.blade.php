				...
				<div class="panel panel-inverse">
					...
					<div class="panel-body">
						<div class="table-responsive">
							...
							<button type="button" id="tambah_new" class="{{$data['btnClass']}} action">{{$data['btnAdd']}}</button><br><br>
					...
					<div class="modal-body">									
						<div class="panel-body panel-form">						
							...
							<div class="form-group row">
								<label class="col-md-4 col-form-label">Kategori Berita</label>
								<div class="col-md-8">
									<input type="text" class="form-control" id="sektor_nama" name="sektor_nama" placeholder="Kategori Berita"/>
								</div>
							</div>																		
						</div>											
					</div>
...
@push('scripts')
	<script src="{{ asset('additional/js/kategori_berita.js?v=1.13') }}"></script>	
@endpush
